...
HD_PWD='C:/Users/kfranz/Desktop/ServoControlwithPmodCON3/ServoControlwithPmodCON3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Servo_interface.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Servo_interface.tcl -notrace
