...
HD_PWD='C:/Users/kfranz/Desktop/ServoControlwithPmodCON3/ServoControlwithPmodCON3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Servo_interface.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Servo_interface.tcl
